                    ...
                    <Row>
                        ...
                        <Col xs={12} sm={12} md={8} lg={7}>
                            <TextBox>
                                ...
                                <p>
                                    Beyond its use as a private residence from the Routt and Bond families, the cabin has served many uses over the years: road house, restaurant, barber shop, and antique store (Susan Bond in 1940's).
                                </p>
